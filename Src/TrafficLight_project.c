...
int main(void){
	// Free GPIO pin (find from reference menu)
	/*
	 * Red light to pin A1
	 * Yellow light to pin  E9
	 * Green to pin B11
	 */

	GPIO_Handle_t Red_light, Yellow_light, Green_light;
	...
	Red_light.GPIO_PinConfig.GPIO_PinOPType = GPIO_OP_TYPE_PP;
